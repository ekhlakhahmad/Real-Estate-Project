...
const Customer = () => {
	return (
		<div className="flex flex-col  p-20 gap-10 bg-[#e2efff]">
			<h1 className="text-center text-4xl pb-5 ">Our Customer Says</h1>
			<div className="flex flex-wrap justify-around gap-12">
				<div className="w-1/4 flex flex-col gap-2 justify-start items-center border-2 border-[#12276e] py-8 rounded-lg">
