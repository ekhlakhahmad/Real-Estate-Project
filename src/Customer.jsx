...
const Customer = () => {
	return (
		<div className="flex flex-col  px-20 gap-10 py-10 bg-[#e2efff]">
			<h1 className="text-center text-4xl pb-5 ">Our Customer Says</h1>
			<div className="flex flex-wrap justify-center gap-12">
				<div className="w-1/4 flex flex-col gap-4 justify-center items-center border-2 border-[#12276e] py-8 rounded-lg">
